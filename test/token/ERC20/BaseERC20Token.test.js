...
const { shouldBehaveLikeBaseERC20Token } = require('./behaviours/BaseERC20Token.behaviour');

const BaseToken = artifacts.require('BaseERC20Token');

contract('BaseERC20Token', function ([owner, anotherAccount, minter, operator, recipient, thirdParty]) {
